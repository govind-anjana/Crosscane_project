      ...
      <main className="container mx-auto px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-0 mb-16">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap gap-4 pt-1 border-t border-gray-50">
              ...
              className="flex-1 border-2 border-gray-200 text-navy-900 px-8 py-5 rounded-2xl font-bold text-[13px] uppercase flex items-center justify-center gap-3 hover:border-gold-500 hover:text-gold-500 transition-all cursor-pointer">
        ...
        <div className="bg-navy-900 rounded-3xl p-12 md:p-16 lg:p-16 relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-12 border border-white/10 shadow-2xl shadow-navy-900/40 group">
          ...
          <div className="flex flex-col sm:flex-row gap-4 z-10 w-full lg:w-auto">
            <a href="/catalog.pdf"
            download
             className="flex-1 lg:flex-none bg-gold-500 text-navy-900 px-12 py-6 rounded-2xl font-bold text-[13px] uppercase tracking-widest hover:bg-white transition-all shadow-2xl shadow-gold-500/20 active:scale-95 flex items-center justify-center gap-3">

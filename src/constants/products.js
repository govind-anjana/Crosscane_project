...
import sayabin from "../assets/images/sayabin.png";
...
export const PRODUCTS = [
  {
    ...
    category: "Agro",
    image: bananapowder,
    shortDesc: "100% natural banana powder made from premium bananas.",
    ...
    exportCapability:
      "Crosscane Overseas is committed to providing high-quality processed agricultural products to global markets. We ensure strict hygiene standards and reliable supply chains to meet the demands of the food and pharmaceutical industries worldwide.",
    pricingInfo: {
  ...
  },
  {
    ...
    category: "Agro",
    image: banana,
    shortDesc: "High-quality Cavendish G9 bananas, fresh and nutritious.",
    price: "Inquire for Price",
    ...
    qualityAssurance: {
      ...
      content:
        "We work directly with trusted farmers and agricultural networks to maintain consistent quality standards throughout cultivation, harvesting, grading, and packaging.",
      points: [
    ...
    exportCapability:
      "Crosscane Overseas is committed to delivering reliable supply solutions with competitive pricing and timely shipment services. We cater to importers, distributors, wholesalers, supermarkets, and retail chains across global markets. Our focus on professionalism, product consistency, and customer satisfaction makes us a trusted partner in the fresh produce export industry.",
    pricingInfo: {
      content: "Pricing may vary depending on:",
      factors: [
        "Product grade & size",
    ...
    specs: [
      ...
      { label: "Packaging", value: "13.5kg / 18kg Cardboard Box" },
    ],
    applications: [
      "Retail",
      "Wholesale",
  ...
  },
  {
    ...
    qualityAssurance: {
      title: "Quality Assurance",
      content:
        "We maintain strict quality control throughout sourcing, processing, grading, and packaging to ensure consistent product standards.",
      points: [
  ...
  },
  {
    ...
    image: onion,
    shortDesc:
      "Fresh premium red onions with strong flavor and long shelf life.",
    price: "Inquire for Price",
  ...
  },
  {
    ...
    category: "Textiles",
    image: bananaFiber,
    shortDesc: "Sustainable banana fiber for eco-friendly applications.",
    price: "Inquire for Price",
    ...
    exportCapability:
      "Crosscane Overseas is dedicated to promoting sustainable and eco-friendly products from India. We offer reliable supply solutions for banana fiber with a focus on quality consistency and timely international shipping to support green industries globally.",
    pricingInfo: {
      content: "Pricing may vary depending on:",
      factors: [
        "Fiber grade & length",
  ...
  // },
  {
    ...
    category: "Spices",
    image: spices,
    shortDesc: "Aromatic and pure spices sourced from the best farms.",
    price: "Inquire for Price",
    ...
    qualityAssurance: {
      ...
      content:
        "We provide a comprehensive selection of premium Indian spices including:",
      points: [
        "Turmeric",
        "Red Chilli",
        "Coriander",
    ...
    exportCapability:
      "Crosscane Overseas is a trusted name in the global spice trade. We ensure that every batch of spices undergoes rigorous quality testing and is packed in moisture-proof containers to maintain freshness during long-distance transit.",
    pricingInfo: {
      content: "Pricing may vary depending on:",
      factors: [
        "Spice variety & grade",
  ...
  },
  {
    ...
    image: jaggery,
    shortDesc: "Natural jaggery powder, a healthy and unrefined sweetener.",
    price: "Inquire for Price",
    ...
    exportCapability:
      "We specialize in the export of traditional Indian sweeteners to health-conscious markets globally. Our jaggery powder is processed to meet international food grade standards, ensuring a pure and reliable supply for our partners.",
    pricingInfo: {
      content: "Pricing may vary depending on:",
      factors: [
  ...
  },
  {
    ...
    category: "Grains",
    image: sayabin,
    shortDesc: "High-grade soyabean, ideal for diverse industries.",
    price: "Inquire for Price",
    ...
    exportCapability:
      "Crosscane Overseas provides robust logistics for bulk soyabean exports. We maintain close ties with farmers and processing centers to ensure a consistent and high-quality supply throughout the export season.",
    pricingInfo: {
      content: "Pricing may vary depending on:",
      factors: [
    ...
    specs: [
      ...
      { label: "Packaging", value: "50kg / Bulk Loading" },
    ],
    applications: [
      "Oil Extraction",
      "Animal Feed",
  ...
  },
  {
    id: 10,
    name: "Rice",
    title: "Premium Rice Supplier & Exporter",
    slug: "rice",
    category: "Grains",
    image: rice,
    shortDesc:
      "Premium quality rice, known for its taste and nutritional value.",
    price: "Inquire for Price",
    tagline: "Premium Export Grade (Kabuli Chana) from India",
    description: [
      "At Crosscane Overseas, we specialize in supplying premium-quality rice sourced from trusted agricultural regions and processed under strict quality standards to meet domestic and international market requirements. Our rice is known for its rich aroma, excellent taste, high purity, and superior grain quality, making it ideal for wholesale, retail, and export distribution.\nWe ensure careful sourcing, hygienic processing, advanced milling, and professional packaging to preserve freshness, nutritional value, and long shelf life throughout storage and transportation.",
    ],
    features: [
      "Premium Export Quality",
      "Rich Aroma & Superior Taste",
      " Uniform Grain Size & High Purity",
      " Hygienically Processed & Packed",
      " Low Moisture Content",
      " Long Shelf Life",
    ],
    ...
    packagingOptions: [
      "5 KG / 10 KG Retail Packs",
      "25 KG / 50 KG PP Packs",
      "Customized Export Packaging",
      "Private Label & Branding Options Available",
    ],
    exportCapability:
      "Crosscane Overseas is committed to delivering reliable supply solutions with competitive pricing and timely shipment services. We cater to importers, wholesalers, distributors, supermarkets, and food processing industries across global markets.With a strong focus on professionalism, consistency, and customer satisfaction, we aim to build long-term business relationships worldwide.",
    pricingInfo: {
      content: "Pricing may vary depending on:",
      factors: [
        "Rice variety & grade",
